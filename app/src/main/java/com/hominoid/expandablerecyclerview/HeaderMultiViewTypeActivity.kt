...
import com.hominoid.expandablerecyclerview.adapter.HeaderMultiViewExpandListAdapter
...
class HeaderMultiViewTypeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = HeaderMultiViewExpandListAdapter(this, listData)
